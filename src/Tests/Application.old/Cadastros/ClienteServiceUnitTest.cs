...
namespace Tests.Application.Cadastros
{
    public class ClienteServiceUnitTest
    {
        ...
        public async Task Buscar_DeveRetornarTodosOsClientes()
        {
            ...
            result.Should().Contain(c => c.Nome == "João" && c.DocumentoIdentificador == "12345678909" && c.TipoDocumentoIdentificador == "CPF");
        ...
        [Fact(DisplayName = "Deve retornar lista vazia quando não h� clientes")]
        [Trait("Metodo", "Buscar")]
